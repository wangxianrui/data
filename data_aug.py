...
class RandomHSV(object):
    ...
    def __init__(self, hue=10, saturation=20, brightness=20):
        if hue:
            self.hue = hue
        else:
            self.hue = 0
...
class AugSequence(object):
    """Initialise Sequence object

    Apply a Sequence of transformations to the image/boxes.
    ...
    def __call__(self, image, bboxes):
        ...
        :param bboxes: [xmin, ymin, xmax, ymax]  with normalized value [0--1]
        :return:
        '''
